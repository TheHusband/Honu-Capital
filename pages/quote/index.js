      ...
      <div className='container mx-auto py-32 text-center xl:text-left flex items-center justify-center h-full'>
        ...
        <div className='flex flex-col w-full max-w-[700px]'>
          ...
          >
            ...
            <div className='flex gap-x-6 w-full'>
              <input type='text' placeholder='Beds' className='input' />
              <input type='text' placeholder='Baths' className='input' />
              <input type='text' placeholder='SQFT' className='input' />
            </div>
            <textarea placeholder='Please explain the condition of the property' className='textarea'></textarea>
